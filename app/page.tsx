      ...
      <main className="flex flex-col md:flex-row min-h-screen bg-gray-50 text-gray-800">
        ...
        <aside className="hidden md:block md:w-46 bg-white border-r border-gray-200 p-3 md:p-6">
          ...
          <button
            ...
            className={`block w-full text-left mb-3 px-3 py-2 rounded-lg transition ${activeTab === 'dashboard'
          ...
          <button
            ...
            className={`block w-full text-left mb-3 px-3 py-2 rounded-lg transition ${activeTab === 'loss'
                ? 'bg-orange-100 text-orange-500 font-semibold'
                : 'text-gray-600 hover:text-orange-500 hover:bg-gray-50'
              }`}
          >
          ...
          <button
            ...
            className={`block w-full text-left px-3 py-2 rounded-lg transition ${activeTab === 'analytics'
                ? 'bg-orange-100 text-orange-500 font-semibold'
                : 'text-gray-600 hover:text-orange-500 hover:bg-gray-50'
              }`}
          >
        ...
        <div className="flex-1 p-3 md:p-6">
          ...
          {activeTab === 'dashboard' && (
            <div className="max-w-7xl mx-auto">
              <div className="mb-6">
                ...
                <div className="flex gap-4 flex-wrap items-center">
                  ...
                  <input
                    ...
                    className="bg-white border border-gray-200 text-gray-700 px-2 py-1 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-orange-400"
                  />
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-7 gap-4 mb-8">
                <Card title="Accuracidade" value={`${accuracy}%`} color={getAccuracyColor()} />
                <Card title="Total" value={total} color="neutral" />
                <Card title="Mapeado" value={totalBipado} color="green" />
                <Card title="Backlog" value={backlog} color="neutral" />
                <Card title="Missing" value={missing} color="red" />
                <Card title="On Hold" value={onHold} color="neutral" />
                <Card title="Esperado" value={expected} color="neutral" />
                <Card title="Inesperado" value={unexpected} color="red" />
                ...
                <Card title="Liquidate" value={liquidate} color="neutral" />
              ...
              <div className="flex gap-2 mb-4">
                {['missing', 'backlog', 'exception', 'mis-sorted', 'liquidate'].map((type) => (
                  <button
                    ...
                    className={`px-3 py-1 rounded-lg text-sm transition ${filterType === type
          ...
          {activeTab === 'loss' && (
            <div className="max-w-6xl mx-auto">
              ...
              <div className="flex gap-4 flex-wrap items-center mb-4 relative">
                <input
                  type="date"
                  value={lossStartDate}
              ...
              <button
                ...
                className="absolute right-0 top-0 text-xs text-gray-400 hover:text-orange-500"
              >
                Baixar Template
              </button>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="flex justify-between items-center bg-white p-6 rounded-xl shadow-sm border border-gray-200 mb-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Análise de causas e performance operacional
                  </p>
                </div>
            ...
            <div className="bg-white p-3 md:p-6 rounded-xl w-[420px] shadow-xl">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 border border-gray-300 p-2 rounded text-gray-700 hover:bg-gray-50"
                >
                  Cancelar
                </button>
          ...
          <div className="bg-white p-6 rounded-2xl w-[400px] shadow-2xl animate-scaleIn">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 border p-2 rounded text-gray-700 bg-gray-50 hover:bg-gray-200"
              >
                Cancelar
              </button>
